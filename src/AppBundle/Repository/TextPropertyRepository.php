...
class TextPropertyRepository extends EntityRepository
{
    ...
    public function findByFullTextSearch($query)
    {
        ...
        $sql = "SELECT txtp.*, c.identifier_in_namespace, cv.standard_label, ns.standard_label as ns_standard_label FROM che.text_property txtp
                ...
                UNION 
                SELECT txtp.*, p.identifier_in_namespace, pv.standard_label, ns.standard_label as ns_standard_label FROM che.text_property txtp
                ...
                UNION 
                SELECT txtp.*, '', ns.standard_label, '' as ns_standard_label FROM che.text_property txtp
                ...
                UNION 
                SELECT txtp.*, '', prf.standard_label, '' as ns_standard_label FROM che.text_property txtp
                ...
                UNION 
                SELECT txtp.*, '', prj.standard_label, '' as ns_standard_label FROM che.text_property txtp
                ...
                UNION 
                SELECT txtp.*, '' as identifier_in_namespace, '' as standard_label, '' as ns_standard_label FROM che.text_property txtp
